...
- RESUELTO "Orelleta" (2026-07-11): era errata de Claude por ORERETA. Investigado: nombre oficial ERRENTERIA (Orden Foral 19-05-1998). Alias del mismo pueblo: Orereta (popular), Renteria (castellano), Errenderi/a (oral, gente mayor). NUEVA TAREA fichada: mapa de alias de pueblos con doble nombre (Errenteria, Donostia/San Sebastian, Arrasate/Mondragon, Soraluze/Placencia...) para Whisper y para las respuestas.
- CERRADO PENDIENTE ESTRELLA (2026-07-11): Gipuzkoa hiru paisaietan funciona en texto Y micro (commit c8ee521). Un solo fetch con 3 coordenadas (Donostia/Arrasate/Ordizia), verificado array de 3 con curl antes de deploy. Respuesta real: "Kostaldean 23 gradu, Debagoienan 20, Goierrin 19".
