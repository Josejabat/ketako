export default async function handler(req, res) {
  ...
  try {
    ...
    const noticiaUrls = {db:'https://barrena.eus/',eibar:'https://etakitto.eus/',dg:'https://goiena.eus/',go:'https://goiena.eus/',tl:'https://tolosaldea.hitza.eus/',oa:'https://oarsoaldea.hitza.eus/',ur:'https://urola.hitza.eus/',bd:'https://bidasoa.hitza.eus/',uk:'https://lea-artibaietamutriku.hitza.eus/'};
